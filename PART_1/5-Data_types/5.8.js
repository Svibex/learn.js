...
// Добавляются новые сообщения и удаляются старые, и вы не знаете в какой
// момент это может произойти.
// Имея такую вводную информацию, решите, какую структуру данных вы могли
// бы использовать для ответа на вопрос «было ли сообщение прочитано?».
...
// добавлять туда свойства. Если сообщения принадлежат какому-то другому
// коду, то это может привести к плохим последствиям.
// Ответ: Здесь стоит использовать WeakSet, которая служит в качестве хранилища
// данных для значений типа «да/нет». Также мы легко можем проверять наличие
// сообщения в нём.
...
// P.S. Даты в JavaScript можно хранить как объекты встроенного
// класса Date, которые мы разберём позднее.
// Ответ: Здесь можно использовать WeakMap для хранения информации о дате.