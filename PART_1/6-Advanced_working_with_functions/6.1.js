...
// Ответ: самый быстрый вариант решения - через прогрессию. Он достаточно короткий.
// Как правило, вариант через цикл обычно быстрее, чем рекурсия.
...
// P.S. Подсказка: n! можно записать как n * (n-1)!
...
// Решение можно было написать через рекурсию, но так как есть условие по
// ограничению времени, используется цикл, так как на его выполнение
...
// Но нагляднее и короче решение через рекурсию.